...
execute as @s at @s run summon minecraft:drowned ~ ~1.6 ~ {"HandItems":[{"id":"minecraft:trident","Count":1},{}],"ArmorItems":[{"id":"minecraft:leather_boots","Count":1},{"id":"minecraft:leather_leggings","Count":1},{"id":"minecraft:leather_chestplate","Count":1},{"id":"minecraft:iron_helmet","Count":1}],"Tags":["ija-a4-newmob"]}
execute as @s[scores={ija-a4-mobamount=2..}] at @s run summon minecraft:drowned ~ ~1.6 ~ {"HandItems":[{"id":"minecraft:trident","Count":1},{}],"ArmorItems":[{"id":"minecraft:leather_boots","Count":1},{"id":"minecraft:leather_leggings","Count":1},{"id":"minecraft:leather_chestplate","Count":1},{"id":"minecraft:iron_helmet","Count":1}],"Tags":["ija-a4-newmob"]}
