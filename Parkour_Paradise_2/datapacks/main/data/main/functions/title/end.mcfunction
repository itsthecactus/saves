...
#Title
title @s[scores={title_end=1}] times 1 100 20
title @s[scores={title_end=2}] title {"color":"yellow","text":"T"}
title @s[scores={title_end=4}] title {"color":"yellow","text":"Th"}
title @s[scores={title_end=6}] title {"color":"yellow","text":"The"}
title @s[scores={title_end=8}] title {"color":"yellow","text":"The "}
title @s[scores={title_end=10}] title {"color":"yellow","text":"The E"}
title @s[scores={title_end=12}] title {"color":"yellow","text":"The En"}
title @s[scores={title_end=14}] title {"color":"yellow","text":"The End"}
...
execute as @s[scores={title_end=280}] run function main:calculatetime/start
execute as @s[scores={title_end=280}] run function main:title/display_time
