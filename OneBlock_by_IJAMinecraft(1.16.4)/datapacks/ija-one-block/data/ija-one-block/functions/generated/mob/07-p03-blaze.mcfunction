...
execute as @s at @s run summon minecraft:blaze ~ ~1.6 ~ {"Tags":["ija-a4-newmob"]}
execute as @s[scores={ija-a4-mobamount=2..}] at @s run summon minecraft:blaze ~ ~1.6 ~ {"Tags":["ija-a4-newmob"]}
