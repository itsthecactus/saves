...
execute as @s at @s run summon minecraft:bee ~ ~1.6 ~ {"AngerTime":3600,"Tags":["ija-a4-newmob"]}
execute as @s at @s run summon minecraft:bee ~ ~1.6 ~ {"AngerTime":3600,"Tags":["ija-a4-newmob"]}
execute as @s[scores={ija-a4-mobamount=3..}] at @s run summon minecraft:bee ~ ~1.6 ~ {"AngerTime":3600,"Tags":["ija-a4-newmob"]}
