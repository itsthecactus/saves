scoreboard players set @s[scores={selected_map=-1}] selected_map 9
scoreboard players set @s[scores={selected_map=10}] selected_map 0
...
execute as @s[scores={selected_map=9}] run function main:maps/9